...
const ArrowDownOnSquareStackIcon = /* @__PURE__ */ componentQrl(inlinedQrl(({ title, titleId, ...props }) => {
...
}, "ArrowDownOnSquareStackIcon_component_Id6RIhXvkMU"));
export {
  ArrowDownOnSquareStackIcon as default
};
