...
const BookmarkSquareIcon = /* @__PURE__ */ qwik.componentQrl(qwik.inlinedQrl(({ title, titleId, ...props }) => {
...
}, "BookmarkSquareIcon_component_o0TIsPVWQAA"));
module.exports = BookmarkSquareIcon;
