...
const ClipboardDocumentIcon = /* @__PURE__ */ componentQrl(inlinedQrl(({ title, titleId, ...props }) => {
...
}, "ClipboardDocumentIcon_component_Hhvq3GupOGs"));
export {
  ClipboardDocumentIcon as default
};
