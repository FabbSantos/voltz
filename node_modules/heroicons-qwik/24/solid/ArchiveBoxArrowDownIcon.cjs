...
const ArchiveBoxArrowDownIcon = /* @__PURE__ */ qwik.componentQrl(qwik.inlinedQrl(({ title, titleId, ...props }) => {
...
}, "ArchiveBoxArrowDownIcon_component_ziJh9gThxRY"));
module.exports = ArchiveBoxArrowDownIcon;
