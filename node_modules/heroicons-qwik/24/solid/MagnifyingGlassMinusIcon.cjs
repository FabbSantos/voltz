...
const MagnifyingGlassMinusIcon = /* @__PURE__ */ qwik.componentQrl(qwik.inlinedQrl(({ title, titleId, ...props }) => {
...
}, "MagnifyingGlassMinusIcon_component_TPlE4gY0Swo"));
module.exports = MagnifyingGlassMinusIcon;
