...
const Square2StackIcon = /* @__PURE__ */ qwik.componentQrl(qwik.inlinedQrl(({ title, titleId, ...props }) => {
...
}, "Square2StackIcon_component_5Rci07ORQHs"));
module.exports = Square2StackIcon;
