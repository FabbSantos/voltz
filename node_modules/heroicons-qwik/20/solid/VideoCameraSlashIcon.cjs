...
const VideoCameraSlashIcon = /* @__PURE__ */ qwik.componentQrl(qwik.inlinedQrl(({ title, titleId, ...props }) => {
...
}, "VideoCameraSlashIcon_component_drTy6z1UIwM"));
module.exports = VideoCameraSlashIcon;
