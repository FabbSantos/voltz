...
const ClipboardDocumentCheckIcon = /* @__PURE__ */ componentQrl(inlinedQrl(({ title, titleId, ...props }) => {
...
}, "ClipboardDocumentCheckIcon_component_jCQqNqzGHgs"));
export {
  ClipboardDocumentCheckIcon as default
};
