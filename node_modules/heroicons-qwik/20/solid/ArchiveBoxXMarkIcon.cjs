...
const ArchiveBoxXMarkIcon = /* @__PURE__ */ qwik.componentQrl(qwik.inlinedQrl(({ title, titleId, ...props }) => {
...
}, "ArchiveBoxXMarkIcon_component_yvhwWPmTVEY"));
module.exports = ArchiveBoxXMarkIcon;
