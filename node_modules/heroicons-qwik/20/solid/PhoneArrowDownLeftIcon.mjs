...
const PhoneArrowDownLeftIcon = /* @__PURE__ */ componentQrl(inlinedQrl(({ title, titleId, ...props }) => {
...
}, "PhoneArrowDownLeftIcon_component_LkaUNYSOLGw"));
export {
  PhoneArrowDownLeftIcon as default
};
