...
const ArrowDownOnSquareIcon = /* @__PURE__ */ componentQrl(inlinedQrl(({ title, titleId, ...props }) => {
...
}, "ArrowDownOnSquareIcon_component_pgv7mnhDwwY"));
export {
  ArrowDownOnSquareIcon as default
};
