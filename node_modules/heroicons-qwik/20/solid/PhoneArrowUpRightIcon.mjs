...
const PhoneArrowUpRightIcon = /* @__PURE__ */ componentQrl(inlinedQrl(({ title, titleId, ...props }) => {
...
}, "PhoneArrowUpRightIcon_component_n1zvKMxG8uQ"));
export {
  PhoneArrowUpRightIcon as default
};
