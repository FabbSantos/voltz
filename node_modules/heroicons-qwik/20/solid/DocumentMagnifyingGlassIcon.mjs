...
const DocumentMagnifyingGlassIcon = /* @__PURE__ */ componentQrl(inlinedQrl(({ title, titleId, ...props }) => {
...
}, "DocumentMagnifyingGlassIcon_component_eMlNDpcN84A"));
export {
  DocumentMagnifyingGlassIcon as default
};
